...
public class Client {
    ...
    public Client(int id, Player player, String url, int port) {
        ...
        try {
             ...
             * Le serveur possÃ¨de un Map(id, socketclient) et crÃ©e ou se met Ã  jour quand des clients communiquent
             * Tous les Ã©changes clients -> serveurs doivent commencer par l'id du client
             *
            ...
            // on reÃ§oit la main de depart + le plateau de jeu, a traiter donc
            // on recupÃ¨re un JSONObject de la forme:
            /**
            ...
            /**
             * Action Ã  effectuer pendant un tour: dÃ©fausser(DISCARD), jouer(PLAY), construire(BUILD)
            ...
            /**
             * Le serveur rÃ©pond Ã  l'action, il faut la traiter en parsant le json obtenu
